#!/usr/bin/env python3
"""XGBoost transaction monitoring model training on AMLSim outputs."""
...
def train_model(df: pd.DataFrame, numeric_cols, categorical_cols, test_size, random_state, model_dir: Path, simulation_name: str):
    ...
    model_path = model_dir / f"{simulation_name}_xgboost.joblib"
    metrics_path = model_dir / f"{simulation_name}_xgboost_metrics.json"
